...
\AddToShipoutPicture{% 
    ...
    \AtPageLowerLeft{% start the bar at the bottom right of the page
        \put(\LenToUnit{\dimexpr\paperwidth-3.9cm},26cm){% move it to the top right
...
\fancypagestyle{mystyle}{
  ...
  \fancyfoot[R]{\fontsize{25}{12}\selectfont\thepage} % Increase the font size by 10pt
  \fancyfootoffset{3.6cm}
}
