...
\[
\begin{align*}
P(\text{Library Member}) & = \frac{18}{18 + 2} \\
P(\text{Vegetarian | Non-Library Member}) & = \frac{2}{2 + 53} \\
P(\text{Vegetarian}) & = \frac{18 + 2}{18 + 2 + 37 + 53}
\end{align*}
\]
...
probVegetarianNonLibrary <- data["No", "Yes"] / sum(data["No", ])
...
\[
\begin{align*}
P(\text{Marathon Runner}) & = \frac{5}{5 + 15} \\
P(\text{Smoker}) & = \frac{15}{5 + 15 + 95 + 85} \\
P(\text{Smoker | Marathon Runner}) & = \frac{5}{5 + 15} \\
P(\text{Marathon Runner | Non-Smoker}) & = \frac{85}{95 + 85}
\end{align*}
\]
...
probMarathonGivenNonSmoker <- data["No", "Yes"] / sum(data["No", ])
...
\[
\begin{align*}
P(\text{Marathon Runner}) & = \frac{2}{2 + 98} \\
P(\text{Smoker}) & = \frac{98}{2 + 98 + 8 + 92} \\
P(\text{Smoker | Marathon Runner}) & = \frac{2}{2 + 98} \\
P(\text{Marathon Runner | Non-Smoker}) & = \frac{92}{8 + 92}
\end{align*}
\]
...
\[
\begin{align*}
P(\text{Undergrad}) & = \frac{5}{5 + 25} \\
P(\text{Skier}) & = \frac{5}{5 + 25 + 15 + 55} \\
P(\text{Skier | Grad}) & = \frac{25}{25 + 55} \\
P(\text{Grad | Snowboarder}) & = \frac{55}{15 + 55} \\
\text{Estimated Population Proportion of Skiing Preference} & = \frac{5}{(5 + 25 + 15 + 55) \times 0.8}
\end{align*}
\]
...
# P(Skier | Grad)
probSkierGivenGrad <- data["Ski", "Grad"] / sum(data[, "Grad"])
print(paste0("P(Skier | Grad) = ", probSkierGivenGrad))

# P(Grad | Snowboarder)
probGradGivenSnowboarder <- data["Snowboard", "Grad"] / sum(data["Snowboard", ])
